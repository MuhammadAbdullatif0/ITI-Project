...
namespace Infrastructure.Services
{
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(IUnitOfWork unitOfWork, IBasketRepo basketRepository,
        ...
        public async Task<CustomerBasket> CreateOrUpdatePaymentIntent(string basketId)
        {
            ...
            var basket = await _basketRepository.GetBaskeAsync(basketId);
            ...
            await _basketRepository.UpdateBaskeAsync(basket);
